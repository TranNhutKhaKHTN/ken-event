      ...
      {!bgReady ? (
        ...
        >
            ...
            {MASTER.map((item, index) => (
              ...
              >
                <img
                  ...
                  className="w-full rounded-xl object-cover"
                />
                <div className={index === 2 ? "pr-2" : ""}>
                  <div className="mt-2 px-0.5 uppercase text-[9px] font-semibold italic leading-snug text-white whitespace-nowrap">
                    {item.role}
                  </div>
                  <div className="mt-2 px-0.5 uppercase text-[9px] font-semibold italic leading-snug text-white whitespace-nowrap">
                    {item.name}
          ...
          <div className="flex flex-col gap-4 items-center justify-center bg-white rounded-2xl mx-5 px-3 pb-5 pt-7">
            <img className="w-full rounded-2xl" src="/xe-1.jpg" alt="" />
            ...
            <div className="text-black font-sans text-center text-sm">
              Địa điểm xuất phát: Tại Toà T, Trường Cao đẳng FPT Polytechnic cơ
              sở TP. Hồ Chí Minh
            </div>
          </div>
          <AttendForm />
