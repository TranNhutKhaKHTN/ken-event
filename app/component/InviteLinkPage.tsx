...
export default function InviteLinkPage({
  ...
  async function copyUrl(path: string, slug: string | "home") {
  ...
  return (
    <div className="min-h-screen bg-[#f5f3fa] px-4 py-8 font-sans">
      <div className="mx-auto w-full max-w-lg">
        ...
        {showHomeLink ? (
          <div className="mt-6 rounded-2xl border border-[#4B2C82]/15 bg-white p-4 shadow-sm">
            <div className="font-medium text-[#4B2C82]">Mời tất cả</div>
            <div className="mt-1 text-xs text-[#888]">Link trang chủ — thư mời chung</div>
            <div className="mt-1 truncate text-xs text-[#888]">/</div>
            <div className="mt-3 flex gap-2">
              ...
              >
                {copiedHome ? "Đã sao chép" : "Sao chép link"}
              </button>
              <Link
                href="/"
                target="_blank"
            ...
            return (
              ...
              >
                ...
                <div className="mt-3 flex gap-2">
                  <button
                    type="button"
                    onClick={() => copyUrl(path, inviter.slug)}
                    className="cursor-pointer rounded-full bg-[#4B2C82] px-4 py-2 text-xs font-medium text-white transition hover:bg-[#3d246c]"
                  >
